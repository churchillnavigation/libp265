...
P265_error video_usability_information::hrd_parameters(error_queue* errqueue, bitreader* br, const seq_parameter_set* sps)
{
  int vlc;
...
P265_error video_usability_information::read(error_queue* errqueue, bitreader* br,
